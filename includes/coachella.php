...
$playlistID = "PL8D4Iby0Bmm8O72jHSjIir0abieLTeuK1";
//CATEGORY OF PLAYLIST NAME AND IMAGE NAME
$playlistImage = "coachella-bg";//CLASS TO CALL THE  FUNCTION TO FETCH DATA FROM API
...
<section class="playlist-page" id="playlist">
	<div class="container">
		<h2 class="text-center text-uppercase text-secondary mb-0 playlist-item-h2">Coachella 2019 Playlist</h2>
