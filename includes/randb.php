...
$playlistID = "PL8D4Iby0Bmm_RcdU5KgREpDbsQAfSlw-I";
//CATEGORY OF PLAYLIST NAME AND IMAGE NAME
$playlistImage = "randb-bg";
...
<section class="playlist-page" id="playlist">
	<div class="container">
		<h2 class="text-center text-uppercase text-secondary mb-0 playlist-item-h2">R&amp;B Playlist</h2>
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="../includes/homepage.php">Home</a></li>
				<li class="breadcrumb-item active" aria-current="page">R&amp;B</li>
			</ol>
		</nav>
		<div class="row">
			<?php 
